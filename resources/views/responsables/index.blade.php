        ...
        <div class="flex justify-between items-center">
            <div class="flex items-center space-x-3">
                ...
                <h2 class="font-bold text-2xl text-gray-800 leading-tight">
                    {{ __('Gestión de Responsables') }}
                </h2>
            </div>
            <a href="{{ route('responsables.create') }}" class="btn-primary">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-6">
                        ...
                        <div id="filter-bar" class="{{ request()->anyFilled(['search']) ? '' : 'hidden' }} bg-gray-50 p-4 rounded-lg border border-gray-100 mb-4">
                            <form action="{{ route('responsables.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="table-header">
                            <tr>
                                ...
                                <th class="px-6 py-4 text-left text-xs font-bold uppercase tracking-widest text-white/90">Cargo</th>
                                ...
                                <tr class="hover:bg-ies-blue-50/50 transition duration-150">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="h-10 w-10 flex-shrink-0 rounded-full bg-ies-blue-100 flex items-center justify-center text-ies-blue-700 font-bold border-2 border-white shadow-sm mr-3">
                                                {{ substr($responsable->nombre, 0, 1) }}{{ substr($responsable->apellidos, 0, 1) }}
                                            </div>
                                            <div class="text-sm font-bold text-gray-900">{{ $responsable->nombre }} {{ $responsable->apellidos }}</div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-right">
                                        <div class="flex justify-end space-x-3">
                                            <a href="{{ route('responsables.show', $responsable) }}" class="text-ies-blue-600 hover:text-ies-blue-900 transition font-bold" title="Ver Detalles">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                            </a>
                                            <a href="{{ route('responsables.edit', $responsable) }}" class="text-ies-green-600 hover:text-ies-green-900 transition font-bold" title="Editar">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path></svg>
                                            </a>
                                            <form action="{{ route('responsables.destroy', $responsable) }}" method="POST" class="inline" onsubmit="return confirm('¿Estás seguro de eliminar a este responsable?')">
                                                @csrf @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="4" class="px-6 py-12 text-center">
                                        <div class="flex flex-col items-center">
                                            ...
                                            <p class="text-gray-500 italic text-lg font-medium">No hay responsables registrados.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
