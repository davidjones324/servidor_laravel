    ...
    <x-slot name="header">
        <div class="flex items-center space-x-2">
            ...
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                {{ __('Editar Coordinador') }}: {{ $coordinador->nombre }} {{ $coordinador->apellidos }}
            </h2>
        </div>
    </x-slot>
                ...
                <form action="{{ route('coordinadores.update', $coordinador) }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="dni" id="dni" value="{{ old('dni', $coordinador->dni) }}" 
                        ...
                        <div>
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $coordinador->nombre) }}" 
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-ies-blue-500 focus:ring-ies-blue-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="apellidos" id="apellidos" value="{{ old('apellidos', $coordinador->apellidos) }}" 
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-ies-blue-500 focus:ring-ies-blue-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email', $coordinador->email) }}" 
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-ies-blue-500 focus:ring-ies-blue-500 sm:text-sm">
                        ...
                        <div>
                            ...
                            <input type="text" name="telefono" id="telefono" value="{{ old('telefono', $coordinador->telefono) }}" 
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-ies-blue-500 focus:ring-ies-blue-500 sm:text-sm">
                    ...
                    <div class="mt-8 flex items-center justify-end space-x-3 pt-4 border-t border-gray-100">
                        <a href="{{ route('coordinadores.index') }}" class="text-sm font-medium text-gray-500 hover:text-gray-700 transition duration-150">
                            {{ __('Cancelar') }}
                        </a>
                        <button type="submit" class="btn-primary">
                            {{ __('Actualizar Coordinador') }}
                        </button>
                    </div>
                </form>
            </div>
